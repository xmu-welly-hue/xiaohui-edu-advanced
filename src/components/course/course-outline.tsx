...
const lessons: Lesson[] = [
  ...
  { number: '04', topic: '代数解题技巧', methods: ['韦达定理进阶', '待定系数法', '赋值法', '试根法'] },
  { number: '05', topic: '导数进阶', methods: ['切线/单调性', '含参讨论'] },
  { number: '06', topic: '函数图像变换', methods: ['平移变换', '对称变换', '翻折变换'] },
  { number: '07', topic: '几何证明利器', methods: ['向量法', '面积法', '斯特瓦尔特定理'] },
  { number: '08', topic: '代数变形进阶', methods: ['换元法', '轮换对称与齐次化', '函数方程思想'] },
  { number: '09', topic: '因式分解进阶', methods: ['十字相乘进阶', '分组分解', '添拆项法'] },
  { number: '10', topic: '对称与构造', methods: ['对称假设法', '放缩法', '构造法'] },
  { number: '11', topic: '数列与规律', methods: ['等差/等比求和', '递推思想'] },
  { number: '12', topic: '数论与逻辑', methods: ['同余模运算', '鸽巢原理', '反证法', '极端原理'] },
  { number: '13', topic: '三角恒等变换', methods: ['和差公式', '倍角/半角公式'] },
  { number: '14', topic: '组合与概率', methods: ['排列组合基本公式', '容斥原理', '二项式定理'] },
  { number: '15', topic: '拉格朗日乘数', methods: ['约束条件下求极值'] },
  { number: '16', topic: '几何定理进阶', methods: ['托勒密定理', '梅涅劳斯/塞瓦定理', '费马点'] },
  { number: '17', topic: '四点共圆与圆幂', methods: ['四点共圆判定', '圆幂定理'] },
  { number: '18', topic: '复数几何', methods: ['旋转与对称'] },
  { number: '19', topic: '数学归纳法', methods: ['证明"对所有n成立"'] },
  { number: '20', topic: '不等式高阶', methods: ['排序不等式', '琴生不等式', '舒尔不等式'] },
    ...
    <section id="outline" ref={ref} className="relative py-20 sm:py-28 bg-navy-950">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className={`text-center mb-14 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">20次课程大纲</h2>
